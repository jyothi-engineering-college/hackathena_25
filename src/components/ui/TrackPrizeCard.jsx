...
const TrackPrizeCard = ({ imgLink, imgAlt, description, value, className }) => {
    ...
    return (
        ...
        >
            <div
                className={`bg-[#101010] relative z-1 ${cardStyle} border-2 rounded-sm border-[#838383] p-3 sm:p-7 lg:p-4 flex flex-col justify-center items-center gap-3 hover:scale-[99%] hover:border-[#ba0403] transition transition-all duration-500`}
